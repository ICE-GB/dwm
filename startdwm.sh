...
while true; do
  log_file=/home/gb/workspace/dwm/logs/dwm-$(date -d "today" +"%Y%m%d%H%M").log
  # Log stderror to a file
  # dwm 2> /home/gb/workspace/dwm/dwm.log
  # No error logging
  #dwm >/dev/null 2>&1
  # log all
  # dwm >>/home/gb/workspace/dwm/dwm.log 2>>/home/gb/workspace/dwm/dwm.log
  # log stderror to a file
  dwm 2>"$log_file"
done
