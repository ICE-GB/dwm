...
static const float mfact                 = 0.6f;      /* 主工作区 大小比例 */
...
static const unsigned int alphas[][3]    = {          /* 透明度设置 ColFg, ColBg, ColBorder */
    ...
    [SchemeBarEmpty] = {((const unsigned int) 0), 0xa0a, ((const unsigned int) 0) },
    [SchemeStatusText] = { OPAQUE, 0x88, ((const unsigned int) 0) },
};

/* 自定义脚本位置 */
static const char *autostartscript = "/home/gb/workspace/dwm/autostart.sh";
static const char *statusbarscript = "/home/gb/workspace/dwm/statusbar/statusbar.sh";
...
static Key keys[] = {
    ...
    { MODKEY,              XK_v,      spawn, SHCMD("/home/gb/workspace/dwm/.bin/clip_history.sh") },                              /* super v          | 剪切板历史             */
